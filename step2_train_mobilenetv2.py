...
Trains MobileNetV2 on preprocessed dataset.
Run after step1_preprocess_dataset.py completes.
...
print("="*80)
print("STEP 2: TRAINING MobileNetV2")
print("="*80)
...
callbacks = [
    ...
    ModelCheckpoint(
        f'{models_dir}/mobilenetv2_best.keras',
...
# ==============================================================================
model_path = f'{models_dir}/mobilenetv2.keras'
...
history_path = f'{models_dir}/mobilenetv2_history.json'
...
plot_path = 'output_plots/mobilenetv2_training.png'
...
print("\nNext step: Run step3_train_efficientnetb0.py")
print("="*80)
