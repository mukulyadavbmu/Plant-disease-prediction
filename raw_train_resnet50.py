"""
Train ResNet50 on RAW images (no DIP preprocessing)
...
print("="*80)
print("TRAINING ResNet50 ON RAW IMAGES (224x224, No DIP)")
print("="*80)
...
callbacks = [
    ...
    ModelCheckpoint(
        filepath=os.path.join(models_dir, 'resnet50_raw_best.keras'),
        monitor='val_accuracy',
        save_best_only=True,
        verbose=1
    )
...
# ==============================================================================
model_path = os.path.join(models_dir, 'resnet50_raw.keras')
history_path = os.path.join(models_dir, 'resnet50_raw_history.json')
plot_path = os.path.join(plots_dir, 'resnet50_raw_training.png')
...
plt.title('ResNet50 (Raw Images) - Accuracy', fontsize=14, fontweight='bold')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('ResNet50 (Raw Images) - Loss', fontsize=14, fontweight='bold')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.grid(True, alpha=0.3)
...
# ==============================================================================
print("\n" + "="*80)
print("ResNet50 (RAW IMAGES) TRAINING COMPLETE!")
print("="*80)
...
print("\nNext: Run raw_evaluate_all_models.py")
print("="*80)
