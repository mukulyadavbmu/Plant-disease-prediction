"""
STEP 3: Train EfficientNetB0 Model
Trains EfficientNetB0 on preprocessed dataset.
Run after step2_train_mobilenetv2.py completes.
...
callbacks = [
    ...
    ModelCheckpoint(
        f'{models_dir}/efficientnetb0_best.keras',
...
# ==============================================================================
model_path = f'{models_dir}/efficientnetb0.keras'
...
history_path = f'{models_dir}/efficientnetb0_history.json'
...
plot_path = 'output_plots/efficientnetb0_training.png'
...
print("\nNext step: Run step4_train_resnet50.py")
print("="*80)
