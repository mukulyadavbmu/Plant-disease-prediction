"""
Train MobileNetV2 on RAW images (no DIP preprocessing)
...
print("="*80)
print("TRAINING MobileNetV2 ON RAW IMAGES (224x224, No DIP)")
print("="*80)
...
callbacks = [
    ...
    ModelCheckpoint(
        filepath=os.path.join(models_dir, 'mobilenetv2_raw_best.keras'),
        monitor='val_accuracy',
        save_best_only=True,
        verbose=1
    )
...
# ==============================================================================
model_path = os.path.join(models_dir, 'mobilenetv2_raw.keras')
history_path = os.path.join(models_dir, 'mobilenetv2_raw_history.json')
plot_path = os.path.join(plots_dir, 'mobilenetv2_raw_training.png')
...
plt.title('MobileNetV2 (Raw Images) - Accuracy', fontsize=14, fontweight='bold')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('MobileNetV2 (Raw Images) - Loss', fontsize=14, fontweight='bold')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.grid(True, alpha=0.3)
...
# ==============================================================================
print("\n" + "="*80)
print("MobileNetV2 (RAW IMAGES) TRAINING COMPLETE!")
print("="*80)
...
print("\nNext: Run raw_train_efficientnetb0.py")
print("="*80)
